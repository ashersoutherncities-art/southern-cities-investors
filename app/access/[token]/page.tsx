    ...
    <div className="min-h-screen bg-gray-50 px-4 py-12">
      <div className="mx-auto max-w-5xl space-y-8">
        <section className="rounded-3xl bg-navy p-10 text-white shadow-sm">
          <p className="text-sm font-semibold uppercase tracking-wide text-orange">Access center</p>
        ...
        <section className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-2xl border border-navy/10 bg-white p-8 shadow-sm">
            ...
            <div className="mt-8 rounded-2xl bg-navy/5 p-6">
              <h2 className="text-xl font-bold text-navy">Your delivery hub</h2>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl border border-navy/10 bg-white p-4">
                  ...
                  <p className="mt-2 text-sm text-navy/65">Use this page to access files, lessons, embeds, or protected links tied to your purchase.</p>
                </div>
                <div className="rounded-xl border border-navy/10 bg-white p-4">
                  <p className="text-sm font-semibold text-navy">Email follow-up</p>
                  <p className="mt-2 text-sm text-navy/65">You will also receive delivery emails and follow-up updates tied to this same access link.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-orange/20 bg-orange/5 p-8 shadow-sm">
              ...
              <h2 className="mt-3 text-2xl font-bold text-navy">Use this as your delivery hub, then get live help when you need it.</h2>
              <p className="mt-4 text-navy/65">If you want direct feedback on your criteria, a live opportunity, or your next step, compare the review offers or apply for investor intake.</p>
