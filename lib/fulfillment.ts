...
export const FULFILLMENT_PRODUCTS: Record<string, FulfillmentProduct> = {
  ...
  'deal-breakdown-vault': {
    ...
    intro: 'Your narrated deal breakdown library is now available. This hub is set up to house ElevenLabs-led lessons and the next-step operator notes tied to each lesson.',
    accessNote: 'Start with the featured lesson flow, then move into the recommended next step when a real deal is on your desk.',
    bullets: [
      'Voice-led breakdown lessons with operator framing',
  ...
  'investor-essentials-membership': {
    ...
    intro: 'Your membership access is active. This hub is the member delivery layer for monthly templates, narrated breakdowns, and next-step implementation prompts.',
    ...
    bullets: [
      ...
      'Member-only narrated training and operator notes',
