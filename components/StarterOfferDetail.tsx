    ...
    <>
      <section className="bg-navy text-white py-24 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <p className="text-orange font-semibold text-sm uppercase tracking-wider mb-4">Starter Offer</p>
      ...
      <section className="py-20 sm:py-24 bg-navy/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-semibold uppercase tracking-wide text-orange">Low-risk first step</p>
          <h2 className="mt-4 text-3xl sm:text-4xl font-bold text-navy">Start with one clear win, then graduate into the right tier.</h2>
          <p className="mt-5 text-lg text-navy/65 max-w-2xl mx-auto">This offer is meant to remove friction. If you need ongoing sourcing, execution, or operator support after this, we will point you to the cleanest Tier 1, Tier 2, or Tier 3 path.</p>
